...
guestName.addEventListener("input", (e) => {
  invitationURI.value =
    "https://dinvite.ajakan.me/nayyudi?to=" + convertToSlug(e.target.value);
  ...
  shareButton.href = `https://api.whatsapp.com/send/?text=https://dinvite.ajakan.me/nayyudi?to=${convertToSlug(
    e.target.value
  )}`;
});
